...
import 'package:social_task/features/auth/presentation/widgets/reset_password_dialog.dart';
...
class _LoginPageState extends State<LoginPage> {
  final TextEditingController _emailController =
      TextEditingController(text: 'telkholy92@gmail.com');
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthCubit, AuthStates>(
      ...
      builder: (context, state) {
        return Scaffold(
          appBar: authAppBar(title: S.current.login),
