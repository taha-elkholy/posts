  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          SizedBox(
            height: size.height * AppSizesTablet.profileWidgetHeightPercentage,
            child: Stack(
              children: [
                SizedBox(
                  width: double.infinity,
                  height: size.height *
                      AppSizesTablet.profileBGImageHeightPercentage,
                  child: const Image(
                  ...
                  child: StatefulBuilder(builder: (context, stateSetter) {
                    return Stack(
                      ...
                      children: [
                        SizedBox(
                          width: size.height *
                              AppSizesTablet.profileImageHeightPercentage,
                          height: size.height *
                              AppSizesTablet.profileImageHeightPercentage,
