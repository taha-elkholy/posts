...
class PostsMobile extends StatefulWidget {
  const PostsMobile({Key? key}) : super(key: key);

  @override
  State<PostsMobile> createState() => _PostsMobileState();
}

class _PostsMobileState extends State<PostsMobile> {
  @override
  void initState() {
    super.initState();
      ...
      builder: (context, state) {
        return Scaffold(
          body: state.maybeWhen(
              ...
              liveLoaded: (posts) =>
                  PostsListMobile(posts: posts, source: PostsSource.live),
